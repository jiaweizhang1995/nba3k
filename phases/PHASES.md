...
| M36| [Draft-pick trading system](M36-draft-picks.md) | ✅ Done | 2026-04-29 | 2026-04-29 | V018 pick resolution fields; offline 420-row pick horizon; live Spotrac overlay verified `420|7|137`; `picks` CLI; `trade propose --send-picks/--receive-picks`; accepted trades transfer picks; draft order uses pick owners; seven-year + Stepien CBA tests green. TUI: trade-builder Picks subcolumn (combined cursor + Space toggle), Roster Picks sub-tab (`1`/`2`), Draft Order screen `via X` rendering, 1-5 star rating per pick (round + year + protection heuristic), god-mode unlock for "Not Tradable" / "FROZEN" picks. 338 passed + 2 ignored. Commits `9c96ca4` → `bd8deb5`. |
